...
<div align= "center">
  <h4>Face Mask Detection system built with OpenCV, Keras/TensorFlow using Deep Learning and Computer Vision concepts in order to detect face masks in static images and static
    videos. Also it is as well as in real-time video streams. Using https://github.com/chandrikadeb7/Face-Mask-Detection. Add Video and webcam function in Streamlit.</h4>
</div>
